...
### Methodology
This documented repository follows a complete engineering cycle, transitioning from intuitive prototyping to data-driven analysis:
...
- **Aerodynamic Wing Geometry**: Implementing a modified KFm-1 (Kline-Fogleman) modified airfoil to optimize lift at low Reynolds numbers (~100,000 RE), supported by a double-reinforced foamboard spar at the 17.3% chord position.
...
Data gathered from an immediate, high-AOA stall event during the first maiden confirmed aft-heavy Center of Gravity at the 56% chord, providing a quantitative baseline for future stabilization systems. The structural integrity of the fuselage was validated by minimal damage when the aircraft suffered a nose-dive impact, with all failure limited to the fracturing of a replacable propellor blade. 
...
Brushless DC motors (BLDC) are more efficient than alternatives due to their superior power-to-weight ratio and efficiency. 
...
- Swappable power pod allows for quickly alternating power setups, including battery and motor types
...
FIGURE 10: The propellor broken at the root
...
- Maximum speed
- Airfoil integity under high-G manuevers
...
This repository serves as a live engineering document. As I transition into more rigorous research environments, I intend to apply these prototyping skills to more complex systems.



*This project remains an ongoing study in aerospace engineering, with the next flight test and data collection upcoming. I will continue editing this repository, keeping it up to date with the latest developments as they arrive.*
